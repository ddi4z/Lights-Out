...
class Interfaz extends JFrame {
    ...
    private PanelOpciones botonesOpciones = new PanelOpciones(azulPrincipal, Color.WHITE,this);
    private PanelInformacion PanelInformacion = new PanelInformacion();
    private PanelConfiguracion botonesConfiguracion=  new PanelConfiguracion(azulPrincipal, this);
